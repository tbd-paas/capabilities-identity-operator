...
type IdentityCapabilityReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewIdentityCapabilityReconciler(mgr ctrl.Manager) *IdentityCapabilityReconciler {
	return &IdentityCapabilityReconciler{
		Name:         "IdentityCapability",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("IdentityCapability-Controller"),
		FieldManager: "IdentityCapability-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("capabilities").WithName("IdentityCapability"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=capabilities.platform.tbd.io,resources=identitycapabilities,verbs=get;list;watch;create;update;patch;delete
...
func (r *IdentityCapabilityReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *IdentityCapabilityReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &capabilitiesv1alpha1.IdentityCapability{}
...
func (r *IdentityCapabilityReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := capabilitiesidentity.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return capabilitiesidentity.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *IdentityCapabilityReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *IdentityCapabilityReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *IdentityCapabilityReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *IdentityCapabilityReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *IdentityCapabilityReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetManager returns the manager object assocated with the reconciler.
func (r *IdentityCapabilityReconciler) GetManager() manager.Manager {
	return r.Manager
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *IdentityCapabilityReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *IdentityCapabilityReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *IdentityCapabilityReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.IdentityCapabilityCheckReady(r, req)
}
...
func (r *IdentityCapabilityReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.IdentityCapabilityMutate(r, req, object)
}

func (r *IdentityCapabilityReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&capabilitiesv1alpha1.IdentityCapability{}).
		Build(r)
	if err != nil {
