...
// sampleIdentityCapability is a sample containing all fields
const sampleIdentityCapability = `apiVersion: capabilities.platform.tbd.io/v1alpha1
kind: IdentityCapability
metadata:
...
const sampleIdentityCapabilityRequired = `apiVersion: capabilities.platform.tbd.io/v1alpha1
kind: IdentityCapability
metadata:
  name: identitycapability-sample
spec:
...
func Sample(requiredOnly bool) string {
	if requiredOnly {
		return sampleIdentityCapabilityRequired
	}

	return sampleIdentityCapability
}

// Generate returns the child resources that are associated with this workload given
// appropriate structured inputs.
func Generate(
	workloadObj capabilitiesv1alpha1.IdentityCapability,
...
func GenerateForCLI(workloadFile []byte) ([]client.Object, error) {
	var workloadObj capabilitiesv1alpha1.IdentityCapability
...
var CreateFuncs = []func(
	*capabilitiesv1alpha1.IdentityCapability,
	workload.Reconciler,
	*workload.Request,
) ([]client.Object, error){
...
func ConvertWorkload(component workload.Workload) (*capabilitiesv1alpha1.IdentityCapability, error) {
	p, ok := component.(*capabilitiesv1alpha1.IdentityCapability)
	if !ok {
		return nil, capabilitiesv1alpha1.ErrUnableToConvertIdentityCapability
	}
